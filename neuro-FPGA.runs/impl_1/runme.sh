...
HD_PWD='C:/Users/Samuel Kebadu/OneDrive - George Mason University - O365 Production/426 stuff/neuro-FPGA/neuro-FPGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log XADC_main.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source XADC_main.tcl -notrace
