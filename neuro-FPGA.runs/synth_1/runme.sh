...
HD_PWD='C:/Users/Samuel Kebadu/OneDrive - George Mason University - O365 Production/426 stuff/neuro-FPGA/neuro-FPGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log XADC_main.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source XADC_main.tcl
